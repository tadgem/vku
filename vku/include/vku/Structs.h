...
namespace vku {
  ...
  public:
    ...
    virtual void                        CreateWindowVKU(VkState& vk, uint32_t width, uint32_t height) = 0;
    ...
    virtual void                        Run(VkState& vk, VKU_FUNCTIONAL_NS::function<void()> callback) = 0;
...
template <>
struct VKU_UNORDERED_MAP_NS::hash<vku::DescriptorSetBinding>
{
    VKU_UNORDERED_MAP_NS::size_t operator()(const vku::DescriptorSetBinding& sb) const
    {
