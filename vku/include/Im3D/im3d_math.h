...
// Vec2
inline Vec2 operator+(const Vec2 &_lhs, const Vec2 &_rhs) {
...
inline Vec2 operator*(const Vec2 &_lhs, float _rhs) {
...
inline float Dot(const Vec2 &_lhs, const Vec2 &_rhs) {
...
// Vec3
inline Vec3 operator+(const Vec3 &_lhs, const Vec3 &_rhs) {
...
inline Vec3 operator*(const Vec3 &_lhs, float _rhs) {
...
// Vec4
inline Vec4 operator+(const Vec4 &_lhs, const Vec4 &_rhs) {
  return Vec4(_lhs.x + _rhs.x, _lhs.y + _rhs.y, _lhs.z + _rhs.z,
              _lhs.w + _rhs.w);
}
inline Vec4 operator-(const Vec4 &_lhs, const Vec4 &_rhs) {
  return Vec4(_lhs.x - _rhs.x, _lhs.y - _rhs.y, _lhs.z - _rhs.z,
...
inline Vec4 operator*(const Vec4 &_lhs, float _rhs) {
  return Vec4(_lhs.x * _rhs, _lhs.y * _rhs, _lhs.z * _rhs, _lhs.w * _rhs);
}
inline Vec4 operator/(const Vec4 &_lhs, float _rhs) {
  return Vec4(_lhs.x / _rhs, _lhs.y / _rhs, _lhs.z / _rhs, _lhs.w / _rhs);
}
...
inline float Dot(const Vec4 &_lhs, const Vec4 &_rhs) {
...
inline Vec4 Abs(const Vec4 &_v) {
  return Vec4(fabs(_v.x), fabs(_v.y), fabs(_v.z), fabs(_v.w));
}
...
inline Mat3 operator*(const Mat3 &_lhs, const Mat3 &_rhs) {
  Mat3 ret;
  ret(0, 0) = _lhs(0, 0) * _rhs(0, 0) + _lhs(0, 1) * _rhs(1, 0) +
              _lhs(0, 2) * _rhs(2, 0);
  ret(0, 1) = _lhs(0, 0) * _rhs(0, 1) + _lhs(0, 1) * _rhs(1, 1) +
              _lhs(0, 2) * _rhs(2, 1);
  ret(0, 2) = _lhs(0, 0) * _rhs(0, 2) + _lhs(0, 1) * _rhs(1, 2) +
              _lhs(0, 2) * _rhs(2, 2);
  ret(1, 0) = _lhs(1, 0) * _rhs(0, 0) + _lhs(1, 1) * _rhs(1, 0) +
              _lhs(1, 2) * _rhs(2, 0);
  ret(1, 1) = _lhs(1, 0) * _rhs(0, 1) + _lhs(1, 1) * _rhs(1, 1) +
              _lhs(1, 2) * _rhs(2, 1);
  ret(1, 2) = _lhs(1, 0) * _rhs(0, 2) + _lhs(1, 1) * _rhs(1, 2) +
              _lhs(1, 2) * _rhs(2, 2);
  ret(2, 0) = _lhs(2, 0) * _rhs(0, 0) + _lhs(2, 1) * _rhs(1, 0) +
              _lhs(2, 2) * _rhs(2, 0);
  ret(2, 1) = _lhs(2, 0) * _rhs(0, 1) + _lhs(2, 1) * _rhs(1, 1) +
              _lhs(2, 2) * _rhs(2, 1);
  ret(2, 2) = _lhs(2, 0) * _rhs(0, 2) + _lhs(2, 1) * _rhs(1, 2) +
              _lhs(2, 2) * _rhs(2, 2);

  return ret;
}
inline Vec3 operator*(const Mat3 &_m, const Vec3 &_v) {
  return Vec3(_m(0, 0) * _v.x + _m(0, 1) * _v.y + _m(0, 2) * _v.z,
              _m(1, 0) * _v.x + _m(1, 1) * _v.y + _m(1, 2) * _v.z,
              _m(2, 0) * _v.x + _m(2, 1) * _v.y + _m(2, 2) * _v.z);
}
inline Vec4 operator*(const Mat3 &_m, const Vec4 &_v) {
  return Vec4(_m(0, 0) * _v.x + _m(0, 1) * _v.y + _m(0, 2) * _v.z,
              _m(1, 0) * _v.x + _m(1, 1) * _v.y + _m(1, 2) * _v.z,
              _m(2, 0) * _v.x + _m(2, 1) * _v.y + _m(2, 2) * _v.z, _v.w);
}
...
inline Mat4 operator*(const Mat4 &_lhs, const Mat4 &_rhs) {
  Mat4 ret;
  ret(0, 0) = _lhs(0, 0) * _rhs(0, 0) + _lhs(0, 1) * _rhs(1, 0) +
              _lhs(0, 2) * _rhs(2, 0) + _lhs(0, 3) * _rhs(3, 0);
  ret(0, 1) = _lhs(0, 0) * _rhs(0, 1) + _lhs(0, 1) * _rhs(1, 1) +
              _lhs(0, 2) * _rhs(2, 1) + _lhs(0, 3) * _rhs(3, 1);
  ret(0, 2) = _lhs(0, 0) * _rhs(0, 2) + _lhs(0, 1) * _rhs(1, 2) +
              _lhs(0, 2) * _rhs(2, 2) + _lhs(0, 3) * _rhs(3, 2);
  ret(0, 3) = _lhs(0, 0) * _rhs(0, 3) + _lhs(0, 1) * _rhs(1, 3) +
              _lhs(0, 2) * _rhs(2, 3) + _lhs(0, 3) * _rhs(3, 3);
  ret(1, 0) = _lhs(1, 0) * _rhs(0, 0) + _lhs(1, 1) * _rhs(1, 0) +
              _lhs(1, 2) * _rhs(2, 0) + _lhs(1, 3) * _rhs(3, 0);
  ret(1, 1) = _lhs(1, 0) * _rhs(0, 1) + _lhs(1, 1) * _rhs(1, 1) +
              _lhs(1, 2) * _rhs(2, 1) + _lhs(1, 3) * _rhs(3, 1);
  ret(1, 2) = _lhs(1, 0) * _rhs(0, 2) + _lhs(1, 1) * _rhs(1, 2) +
              _lhs(1, 2) * _rhs(2, 2) + _lhs(1, 3) * _rhs(3, 2);
  ret(1, 3) = _lhs(1, 0) * _rhs(0, 3) + _lhs(1, 1) * _rhs(1, 3) +
              _lhs(1, 2) * _rhs(2, 3) + _lhs(1, 3) * _rhs(3, 3);
  ret(2, 0) = _lhs(2, 0) * _rhs(0, 0) + _lhs(2, 1) * _rhs(1, 0) +
              _lhs(2, 2) * _rhs(2, 0) + _lhs(2, 3) * _rhs(3, 0);
  ret(2, 1) = _lhs(2, 0) * _rhs(0, 1) + _lhs(2, 1) * _rhs(1, 1) +
              _lhs(2, 2) * _rhs(2, 1) + _lhs(2, 3) * _rhs(3, 1);
  ret(2, 2) = _lhs(2, 0) * _rhs(0, 2) + _lhs(2, 1) * _rhs(1, 2) +
              _lhs(2, 2) * _rhs(2, 2) + _lhs(2, 3) * _rhs(3, 2);
  ret(2, 3) = _lhs(2, 0) * _rhs(0, 3) + _lhs(2, 1) * _rhs(1, 3) +
              _lhs(2, 2) * _rhs(2, 3) + _lhs(2, 3) * _rhs(3, 3);
  ret(3, 0) = _lhs(3, 0) * _rhs(0, 0) + _lhs(3, 1) * _rhs(1, 0) +
              _lhs(3, 2) * _rhs(2, 0) + _lhs(3, 3) * _rhs(3, 0);
  ret(3, 1) = _lhs(3, 0) * _rhs(0, 1) + _lhs(3, 1) * _rhs(1, 1) +
              _lhs(3, 2) * _rhs(2, 1) + _lhs(3, 3) * _rhs(3, 1);
  ret(3, 2) = _lhs(3, 0) * _rhs(0, 2) + _lhs(3, 1) * _rhs(1, 2) +
              _lhs(3, 2) * _rhs(2, 2) + _lhs(3, 3) * _rhs(3, 2);
  ret(3, 3) = _lhs(3, 0) * _rhs(0, 3) + _lhs(3, 1) * _rhs(1, 3) +
              _lhs(3, 2) * _rhs(2, 3) + _lhs(3, 3) * _rhs(3, 3);
...
Mat4 AlignZ(const Vec3 &_axis,
            const Vec3 &_up = Vec3(
                0.0f, 1.0f, 0.0f)); // generate an orthonormal bases with +z as
                                    // _axis, which must be unit length
Mat4 LookAt(const Vec3 &_from, const Vec3 &_to,
            const Vec3 &_up = Vec3(
                0.0f, 1.0f,
                0.0f)); // align _z with (_to - _from), set _from as translation
...
bool Intersect(const Ray &_ray, const Capsule &_capsule, float &t0_,
               float &t1_);

// Find point t0_ along _line0 nearest to _line1 and t1_ along _line1 nearest to
// _line0.
void Nearest(const Line &_line0, const Line &_line1, float &t0_, float &t1_);
// Find point tr_ along _ray nearest to _line and tl_ along _line nearest to
// _ray.
void Nearest(const Ray &_ray, const Line &_line, float &tr_, float &tl_);
// Find point tr_ along _ray nearest to _segment, return point on segment
// nearest to _ray.
...
inline float Distance(const Vec4 &_plane, const Vec3 &_point) {
  return _plane.x * _point.x + _plane.y * _point.y + _plane.z * _point.z -
         _plane.w;
}
...
template <> struct TypeTraits<Vec2> {
  typedef VecT Type;
  enum { kSize = 2 };
};
template <> struct TypeTraits<Vec3> {
  typedef VecT Type;
  enum { kSize = 3 };
};
template <> struct TypeTraits<Vec4> {
  typedef VecT Type;
  enum { kSize = 4 };
};
template <> struct TypeTraits<Mat4> {
  typedef MatT Type;
  enum { kSize = 16 };
};

template <typename T> inline bool _AllLess(const T &_a, const T &_b, ScalarT) {
  return _a < _b;
}
template <typename T>
...
template <typename T> inline T _Max(const T &_a, const T &_b, ScalarT) {
  return _a < _b ? _b : _a;
}
template <typename T> inline T _Max(const T &_a, const T &_b, CompositeT) {
  T ret;
  for (int i = 0, n = TypeTraits<T>::kSize; i < n; ++i) {
...
template <typename T> inline T _Min(const T &_a, const T &_b, ScalarT) {
  return _a < _b ? _a : _b;
}
template <typename T> inline T _Min(const T &_a, const T &_b, CompositeT) {
  T ret;
  for (int i = 0, n = TypeTraits<T>::kSize; i < n; ++i) {
...
template <typename T> inline bool AllLess(const T &_a, const T &_b) {
  return internal::_AllLess(_a, _b, typename internal::TypeTraits<T>::Type());
}

template <typename T> inline T Max(T _a, T _b) {
  return internal::_Max(_a, _b, typename internal::TypeTraits<T>::Type());
}
template <typename T> inline T Min(T _a, T _b) {
  return internal::_Min(_a, _b, typename internal::TypeTraits<T>::Type());
}
template <typename T> inline T Clamp(T _a, T _min, T _max) {
  return Max(Min(_a, _max), _min);
}

// Remap _x in [_start,_end] to [0,1].
inline float Remap(float _x, float _start, float _end) {
  return Clamp(_x * (1.0f / (_end - _start)) + (-_start / (_end - _start)),
               0.0f, 1.0f);
}
