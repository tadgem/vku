...
// legacy io.KeyMap[]+io.KeysDown[] in favor io.AddKeyEvent(). This is
// automatically done by IMGUI_DISABLE_OBSOLETE_FUNCTIONS.
...
// will need to call ImGui::SetAllocatorFunctions(). #define IMGUI_DISABLE_SSE
...
// rsvg-port.c which is licensed under CeCILL-C Free Software License Agreement)
