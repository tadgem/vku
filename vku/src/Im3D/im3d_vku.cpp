...
namespace vku
{
    ...
    VkuIm3dViewState AddIm3dForViewport(VkState& vk, VkuIm3dState& state, VkRenderPass renderPass, bool enableMSAA, bool enableDynamicRendering)
    {
    ...
    VkuIm3dViewState AddIm3dForGBufferRenderPass(VkState& vk, VkuIm3dState& state, VkRenderPass gbufferRenderPass)
    {
        auto vertexDescription = VertexDataPos4::GetVertexDescription(*vk.m_CPUAllocator);
    ...
    void DrawIm3d(VkState& vk, VkCommandBuffer& buffer, uint32_t frameIndex, VkuIm3dState& state, VkuIm3dViewState& viewState, glm::mat4 _viewProj, uint32_t width, uint32_t height, bool drawText)
    {
