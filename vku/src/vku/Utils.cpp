...
uint32_t vku::utils::FindMemoryType(VkState &vk, uint32_t typeFilter,
...
VkFormat vku::utils::FindSupportedFormat(VkState &vk,
...
VkFormat vku::utils::FindDepthFormat(VkState &vk) {
  ...
  return FindSupportedFormat(vk, formats, VK_IMAGE_TILING_OPTIMAL,
